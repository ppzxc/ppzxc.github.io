---
id: 69
slug: /posts/StandardOfJava,Chapter13.Thread
date: 2017-04-10 18:10:59
title: Standard Of Java, Chapter 13. Thread
subtitle: 
tags: [자바의정석]
...
* synchronized 블럭은 자동적으로 잠기고 풀린다. 블럭 내에서 예외가 발생해도  lock은 자동적으로 풀리기 때문에 편리하다
* 하지만 같은 메서드 내에서만 lock을 걸 수 있다는 제약이 불편할때 java.util,concurrent.locks를 이용한다.
